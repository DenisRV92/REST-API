...
return [
    ...
    */
    ...
    'project_name' => 'Admin Admin Panel',
    ...
    // Show "Getting Started with Admin" info block?
    ...
    // Show powered by Laravel Admin in the footer? true/false
    ...
    */
    ...
    // Admin will prevent visitors from requesting password recovery too many times
    ...
    // Admin will prevent an IP from trying to reset the password too many times,
...
//    'user_model_fqn' => config('auth.providers.users.model'),
    ...
    'middleware_class' => [
        ...
        // \Admin\CRUD\app\Http\Middleware\UseBackpackAuthGuardInsteadOfDefaultAuthGuard::class,
    ],
    ...
    // The Admin default is the same as the Laravel default (email)
    // If you need to switch to username, you also need to create that column in your db
    'authentication_column'      => 'email',
    'authentication_column_name' => 'Email',

    // The guard that protects the Admin admin panel.
    // If null, the config.auth.defaults.guard value will be used.
    'guard' => 'backpack',

    // The password reset configuration for Admin.
    ...
    |--------------------------------------------------------------------------
    */
    // Change the view namespace in order to load a different theme than the one Admin provides.
    // You can create child themes yourself, by creating a view folder anywhere in your resources/views
    // and choosing that view_namespace instead of the default one. Admin will load a file from there
    ...
    // Tell Admin to look in more places for component views (like widgets)
    ...
    */
    ...
    // Admin\Base sets up its own filesystem disk, just like you would by
    // adding an entry to your config/filesystems.php. It points to the root
    // of your project and it's used throughout all Admin packages.
    //
    ...
    |--------------------------------------------------------------------------
    |
    | If you have access to closed-source Admin add-ons, please provide
